...
/**
 * Pending Post Alert Settings Controller
 *
 * PHP version 5
 ...
 * @module	   Pending Post Alert Settings Controller	
...
class PendingPostAlert_Settings_Controller extends Admin_Controller
{
	public function index()
	{
		...
		$this->template->content->title = "Pending Post Alert Settings";
		
		// Settings Form View
		$this->template->content->settings_form = new View("pendingpostalert/admin/pendingpostalert_settings");
        ...
        if ($_POST)
        {
            ...
            $post->add_rules('pendingpostalert_emails','required', 'length[1,200]');
